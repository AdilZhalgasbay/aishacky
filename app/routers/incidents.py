...
ASSIGNEE_MAP = {
    ...
    "мышка": "IT-специалист", "клавиатура": "IT-специалист", "монитор": "IT-специалист",
    "туалет": "Завхоз", "отопление": "Завхоз", "дверь": "Завхоз", "замок": "Завхоз",
...
ПРАВИЛА:
1. 'is_incident' — true, если это поломка, проблема, жалоба или инцидент.
2. 'type' — категория (технический, дисциплинарный, санитарный, медицинский).
3. 'priority' — low, medium, high.
4. 'assignee' — кто должен решить (Завхоз, IT-специалист, Медсестра, Охрана, Директор).
